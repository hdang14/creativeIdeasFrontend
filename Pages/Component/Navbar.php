    ...
    <div class="icons" style="font-size: 24px;">
        ...
        <li class="nav-item dropdown" style="padding-left: 30px;">
            ...
            <div class="dropdown-menu" style="background-color: #F5F5DC;">
                <h6 id="user_name" style="font-size: 17px;" class="dropdown-header"> <script>getName()</script> </h6>
        ...
        <a class="cartDisplay" href="../OrderPages/OrderInCart.php"><i style="margin-left:25px; color: black;" class="bi bi-cart"></i>
            <p class='badge badge-warning' id='cart-size'> 0 </p>
        </a>
